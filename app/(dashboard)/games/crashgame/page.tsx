...
export default function CrashGameLobby() {
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gradient-to-b from-slate-950 via-slate-900 to-black text-white">
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-sm md:text-base text-slate-400 max-w-xl">
              Obserwuj jak mnożnik rośnie! Wypłać w odpowiednim momencie, zanim
              rakieta wybuchnie. Szybkie rundy i wysokie wygrane.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start md:items-end gap-2">
            ...
            <p className="text-[11px] text-slate-500">
              Połączony z Socket.io na porcie 3001
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Standard room */}
          <Link href="/games/crashgame/standard" className="group">
              ...
              <div className="relative z-10 flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-400">
                    Idealny na start, spokojne tempo rozgrywki i niskie limity
                    zakładów.
                  </p>
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-slate-300">
                    <div>
                      ...
                      <div className="font-semibold text-emerald-300">$5</div>
                    </div>
          ...
          {/* VIP room */}
          <Link href="/games/crashgame/vip" className="group">
              ...
              <div className="relative z-10 flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-300">
                    Dla graczy szukających mocnych emocji, wysokich limitów i
                    intensywnego tempa.
                  </p>
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-slate-200">
                    <div>
                      ...
                      <div className="font-semibold text-yellow-300">$50</div>
                    </div>
                    <div className="h-8 w-px bg-slate-800" />
                    <div>
                      <div className="text-slate-400 text-[11px] uppercase tracking-wide">
